...
// question, how to case edge the userName to ensure we get a name and not a number.
...
let userColor = prompt(`${userName}, What is your favorite color?`, "red, orange, yellow, green, blue, pink, purple, black, white, and grey");
...
switch (userColor.toLowerCase()) {
  case 'red':
    alert(`${userName}, roses are red. Good choice.`);
    break;
  case 'blue':
    alert(`${userName} have you heard of the "I'm blue song?"`);
    break;
  case 'orange':
    alert(`Orange is a nice color. Great taste ${userName}.`)
    break;
  case 'yellow':
    alert(`Look at the stars, look how they shine for you, ${userName}.`)
    break;
  case 'green':
    alert(`Green eggs and ham, ${userName}, green eggs and ham.`)
    break;
  case 'pink':
    alert(`Do you know any of Pink's song ${userName}?`)
    break;
  case 'purple':
    alert(`${userName}, do you also think of the Joker when you think of purple?`)
    break;
  case 'black':
    alert(`Black like my heart ${userName}. Like my heart.`)
    break;
  case 'white':
    alert(`Ah, the color of the innocent. Interesting choice ${userName}.`)
    break;
  case 'grey':
    alert(`What shade of grey are you ${userName}?`)
    break;
  default:
    alert(`Please pick one of the 10 colors ${userName}.`);
    break;
}

function loadYourName() {
    document.getElementById("yourName").innerHTML =`${userName} your favorite color is ${userColor}`;
}
